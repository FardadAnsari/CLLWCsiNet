...
class CsiNet(torch.nn.Module):
    def __init__(self, img_height=32, img_width=32, img_channels=2, residual_num=2, encoded_dim=512):
        ...
        self.fully_connect_layer=torch.nn.Linear(encoded_dim,1024)
        self.sigmoid_sparse=torch.nn.Sigmoid()
        self.fully_connect_layer_2=torch.nn.Linear(1024,encoded_dim)
        
        self.fully_connect_layer_3=torch.nn.Linear(encoded_dim, img_total)
